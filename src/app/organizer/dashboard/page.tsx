        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap gap-2">
              <Button asChild variant="outline">
                <Link href="/organizer/create-voucher">
                  <Tag className="mr-2 h-4 w-4" /> Buat Voucher
                </Link>
              </Button>
              <Button asChild>
          ...
          <div className="grid gap-4 md:grid-cols-3 mb-8">
            <StatCard
              ...
              value={formatPrice(dashboardData?.stats?.revenue ?? 0)}
              icon={DollarSign}
            />
            <StatCard
              title="Tiket Terjual (Bulan Ini)"
              value={`${dashboardData?.stats?.ticketsSold ?? 0}`}
              icon={Ticket}
            />
            <StatCard
              title="Total Event (Keseluruhan)"
                                ...
                                {trx.status === "PENDING_CONFIRMATION" &&
                                  trx.paymentProofUrl && (
                                    <Button variant="outline" size="sm" asChild>
                                      <a
                                        href={`${API_BASE_URL}${trx.paymentProofUrl}`}
                                        target="_blank"
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      ...
                      >
                        ...
                        />
                        <Tooltip
                          formatter={(value) => `${Number(value ?? 0)} tiket`}
                        />
                        <Legend />
                        <Bar
                          dataKey="sold"
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tindakan ini tidak dapat diurungkan. Ini akan menghapus event
              secara permanen.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
