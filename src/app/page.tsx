    ...
    <Link href={`/events/${event.slug}`} className="block group">
      <Card className="hover:shadow-lg transition-shadow duration-300 h-full flex flex-col bg-card">
        ...
        <CardContent className="p-4 flex-grow flex flex-col">
          <Badge variant="outline" className="text-xs shrink-0 w-fit mb-2">
            {event.category}
          </Badge>
          <CardTitle className="text-base md:text-lg line-clamp-2 flex-grow">
            {event.name}
          </CardTitle>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <div className="w-full text-left">
                <Label htmlFor="startDate" className="text-xs ml-1">
                  Dari Tanggal
                </Label>
                <Input
                  id="startDate"
              ...
              <div className="w-full text-left">
                <Label htmlFor="endDate" className="text-xs ml-1">
                  Sampai Tanggal
                </Label>
                <Input
                  id="endDate"
