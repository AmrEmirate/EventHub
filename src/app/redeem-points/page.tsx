  ...
  const handleRedeem = async (prize: PointPrize) => {
    ...
    try {
      ...
      toast.success("Berhasil!", {
        description: `Anda berhasil menukar poin dengan ${prize.name}. Cek kupon Anda!`,
      });
    ...
    <div className="container mx-auto py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          Gunakan poin yang sudah Anda kumpulkan untuk mendapatkan hadiah
          menarik!
        </p>
        <p className="text-lg font-semibold mt-2">
          Poin Anda saat ini: {user?.points?.toLocaleString() || 0}
        </p>
      </div>
            ...
            <CardContent className="flex-grow flex flex-col justify-end">
              <div className="mb-4">
                <p className="text-2xl font-bold text-primary">
                  {prize.pointsRequired.toLocaleString()} Poin
                </p>
              </div>
              <Button
                className="w-full"
                ...
                disabled={
                  ...
                  (user ? user.points < prize.pointsRequired : true)
                }
              >
                {redeemingId === prize.id && (
