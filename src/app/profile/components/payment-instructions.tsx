  ...
  return (
    <Card className="mt-6 border-blue-500 animate-in fade-in-50">
      <CardHeader>
        ...
        <CardDescription>
          Silakan transfer sejumlah total tagihan ke salah satu rekening di
          bawah ini sebelum waktu habis.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div>
          ...
          <p
            ...
            onClick={() =>
              copyToClipboard(transaction.finalPrice.toString(), "Total Harga")
            }
          >
            ...
            <div key={acc.bank} className="p-3 border rounded-md">
              ...
              <div className="flex justify-between items-center mt-1">
                ...
                <Button
                  size="sm"
                  variant="ghost"
                  onClick={() => copyToClipboard(acc.number, "Nomor Rekening")}
                >
                  Salin
                </Button>
              </div>
        ...
        <p className="text-xs text-muted-foreground">
          PENTING: Pastikan Anda mentransfer sesuai jumlah total di atas (tanpa
          pembulatan) agar pembayaran dapat diverifikasi secara otomatis.
        </p>
      </CardContent>
    </Card>
  );
