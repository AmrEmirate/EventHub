...
export default function CouponsTab() {
  ...
  const copyToClipboard = (code: string) => {
    ...
    toast.info("Kode Disalin!", {
      description: `${code} telah disalin ke clipboard.`,
    });
  };
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Ini adalah daftar kode diskon aktif yang Anda miliki. Klik kode untuk
          menyalin.
        </CardDescription>
      </CardHeader>
        ...
        {vouchers.length > 0 ? (
                ...
                <div className="flex-grow">
                  ...
                  {voucher.event ? (
                    <p className="text-xs text-primary font-medium">
                      Khusus untuk event: {voucher.event.name}
                    </p>
                  ) : (
          ...
          <div className="text-center text-muted-foreground py-10">
            ...
            <p className="mt-4 font-semibold">
              Anda belum memiliki kupon atau voucher aktif.
            </p>
            <p className="text-sm">
              Dapatkan kupon dengan mendaftar menggunakan kode referral!
            </p>
          </div>
        )}
      </CardContent>
